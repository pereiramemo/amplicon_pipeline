...
# tools
dada2_pipeline="${AMPLICON_PIPELINE_SCRIPTSV2}/dada2_pipeline.R"
primers_removal="${AMPLICON_PIPELINE_SCRIPTSV2}/primers_removal.R"
taxa_annot="${AMPLICON_PIPELINE_SCRIPTSV2}/taxa_annot.R"
